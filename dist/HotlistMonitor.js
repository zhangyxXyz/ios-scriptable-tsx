...
// src/scripts/HotlistMonitor.tsx
      ...
      if (
        ...
        return /* @__PURE__ */ h(
          ...
          /* @__PURE__ */ h(
            ...
            (() => {
              const hotType =
                this.currentSettings.basicSettings.hotType.val || "history";
              const label = this.hotTypeLabelMap[hotType] || "聚合热榜";
              let title = `🔥 ${label}`;
              if (
                this.currentSettings.displaySettings.showTitleDate.val &&
                this.httpData.data.update_time
              ) {
