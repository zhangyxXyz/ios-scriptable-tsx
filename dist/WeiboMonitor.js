...
var Widget = class extends WidgetBase {
    ...
    this.renderCommon = async (w) => {
      if (
        ...
        return /* @__PURE__ */ h(
          "wbox",
          {
            spacing: this.currentSettings.displaySettings.isEnhancedEffect.val
              ? this.currentSettings.displaySettings.enhancedModeDataSpacing.val
              : this.currentSettings.displaySettings.noEnhancedModeDataSpacing
                  .val,
          },
          /* @__PURE__ */ h("wspacer", {
            length: 5,
  ...
  async getData() {
    ...
    try {
      ...
      if (data && data.data && data.data.cards !== void 0) {
        this.httpData = data;
