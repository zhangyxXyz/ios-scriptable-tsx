    ...
    Run() {
        if (config.runsInApp) {
            ...
            this.registerExtraSettingsCategoryItem(
                ...
                '填写对应分类字母(可组合多个)\n留空代表全分类\n\na ==> 动画\nb ==> 漫画\nc ==> 游戏\nd ==> 文学\ne ==> 原创\nf ==> 来自网络\ng ==> 其他\nh ==> 影视\ni ==> 诗词\nj ==> 网易云\nk ==> 哲学\nl ==> 抖机灵\n缺省值: 全分类',
                { filterTypeString: '' },
                'https://raw.githubusercontent.com/zhangyxXyz/PicGallery/master/IconSet/Scriptable/Settingsflow.png',
                [],
                '全分类'
            )
        ...
        if (this.httpData) {
            ...
            return /* @__PURE__ */ h(
                ...
                /* @__PURE__ */ h(
                    ...
                    /* @__PURE__ */ h('wimage', {
                        /* src: 'https://raw.githubusercontent.com/zhangyxXyz/PicGallery/master/IconSet/Scriptable/Application/OneWord.png', */
