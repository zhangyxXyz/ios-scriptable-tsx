...
class Widget extends BaseWidget {
    constructor(scriptName) {
        ...
        this.backgroundColor = '#000000,#000000'
        this.defaultConfig.bgType = '2'
        this.titleColor = Color.dynamic(new Color('#AAAAAA'), new Color('#AAAAAA'))
        this.descColor = Color.dynamic(new Color('#EEEEEE'), new Color('#EEEEEE'))
        this.subTitleColor = Color.dynamic(new Color('#AAAAAA'), new Color('#AAAAAA'))
    }
    ...
    async render({ widgetSetting, family }) {
        return await this.provideLargeWidget(family, widgetSetting)
    }

    async provideLargeWidget(widgetFamily, widgetSetting) {
        let name = '大号'
        let sizeSplit = 0.7
        let descSpan = 16
        let useMoviePoster4FullBG = true
        switch (widgetFamily) {
            case 'small':
                name = '小号'
                sizeSplit = 0.5
                descSpan = 2
                useMoviePoster4FullBG = false
                break
            case 'medium':
                sizeSplit = 0.45
                name = '中号'
        ...
        topStack.setPadding(0, 16, descSpan, descSpan)
        topStack.size = new Size(widgetSize.width, widgetSize.height * sizeSplit)
        if (!useMoviePoster4FullBG) {
            topStack.backgroundColor = this.dynamicColor('#000000', '#000000')
        }
        topStack.addSpacer()
        //
        ...
        bottomStack.backgroundColor = this.dynamicColor('#000000', '#000000')
        bottomStack.size = new Size(widgetSize.width, widgetSize.height * (1 - sizeSplit))
        ...
        movieInfoStack.url = `${this.domain}${movieLink}`
        ...
        if (useMoviePoster4FullBG) {
            ...
            dateStack.backgroundImage = image
        }
        return widget
    }
