...
class Widget extends DmYY {
  ...
  logo = 'https://raw.githubusercontent.com/zhangyxXyz/PicGallery/master/ImageHost/2023/03/19/20-41-13-694a340a6a0dfce4c9e56554cff6d9dc-logoImage-8c1ef3.png';
  JDImg = 'https://pic.imgdb.cn/item/63132fbf16f2c2beb1f33a97.png';
  beanImg = 'https://pic.imgdb.cn/item/63132fda16f2c2beb1f35611.png';
  plusFG =
    'https://raw.githubusercontent.com/githubdulong/Script/master/Images/plusFG.png';
  plusBG =
    'https://raw.githubusercontent.com/githubdulong/Script/master/Images/plusBG.png';
  baitiaoImg = 'https://pic.imgdb.cn/item/6313300f16f2c2beb1f387f0.png';
  plusIcon =
    'https://raw.githubusercontent.com/githubdulong/Script/master/Images/IMG_0610.png';
  ...
  gangbengImg = 'https://raw.githubusercontent.com/zhangyxXyz/PicGallery/master/ImageHost/2023/03/19/20-38-03-259b270a3c47a7003694f1227c20199d-gbImage-1d44c9.png';
  userImage =
  ...
  colorfulBar() {
    let colorArr = [
      ...
      ['#F46277', '#FC8D59', '#FEE08B', '#E6F598', '#99D594', '#3288BD'],
      ['#A6CEE3', '#1F78B4', '#B2DF8A', '#33A02C', '#FB9A99', '#E31A1C'],
      ['#E41A1C', '#377EB8', '#4DAF4A', '#984EA3', '#FF7F00', '#9ED80E'],
      ...
      ['#FBC01E', '#EFE1A2', '#FA8716', '#F2575F', '#A5D848', '#A155F9'],
      ['#90C226', '#54A021', '#E6B91E', '#E76618', '#C42F1A', '#FA8716'],
      ['#0F6FC6', '#009DD9', '#0BD0D9', '#10CF9B', '#7CCA62', '#A5C249'],
      ['#FFB91D', '#F97817', '#6DE304', '#F98080', '#8F58F9', '#F789EA'],
      ...
      ['#3891A7', '#FEB80A', '#FC8389', '#84AA33', '#F9934E', '#4379EF'],
      ['#990000', '#FF6600', '#FFBA00', '#99CC00', '#528A02', '#9C007F'],
      ['#F7901E', '#FEC60B', '#9FE62F', '#4EA5D1', '#4282EA', '#854FED'],
      ['#E8BC4A', '#83C1C6', '#E78D35', '#909CE1', '#839C41', '#F9826E'],
      ['#86CE24', '#00A2E6', '#FAC810', '#AA69F7', '#D06B20', '#FF8021'],
  ...
  async setUserShow(stack) {
    ...
    if (this.package.number > 0) {
      ...
      packageStack.setPadding(
        1 * this.basicSetting.scale,
        2 * this.basicSetting.scale,
        1 * this.basicSetting.scale,
        2 * this.basicSetting.scale
      );
    ...
    if (this.isPlus) {
      ...
      const nameIcon = nameStack.addImage(
        await this.getImageByUrl(this.nameImg, 'nameImg.png')
      );
    ...
    const lableIcon = valueStack.addImage(
      await this.getImageByUrl(this.tagImg, 'tagImg.png')
    );
  ...
  async setHeaderShow(stack, image) {
    ...
    if (image) {
      ...
      if (this.isPlus) {
        imgStack.size = new Size(
          30 * this.basicSetting.scale,
          30 * this.basicSetting.scale * 1.039
        );
        imgStack.backgroundImage = await this.getImageByUrl(
          this.plusBG,
          'plusBGImage.png'
  ...
  TotalBean = async () => {
    ...
    const url =
      'https://me-api.jd.com/user_new/info/GetJDUserInfoUnion?isLogin=1';
    const options = {
      headers: {
        cookie: this.cookie,
      },
  ...
  wxData = async () => {
    ...
    const url =
      'https://wxapp.m.jd.com/kwxhome/myJd/home.json?&useGuideModule=0&bizId=&brandId=&fromType=wxapp&isLogin=1';
    const options = {
      headers: {
        cookie: this.cookie,
      },
    ...
    try {
      if (response['user']) {
        this.jValue = response.user.uclass.replace(/[^0-9]/gi, '');
      } else {
        // this.notify(this.name, response.msg);
    ...
    try {
      ...
      if (data.errcode === 0) {
        ...
        if (data.data.expiredBalance && data.data.expiredBalance !== '')
          this.redPackage.desc = `即将过期${data.data.expiredBalance}` + '元';
      } else {
  ...
  getJValue = async () => {
    const dataName = '京享数据';
    const url =
      "https://api.m.jd.com/?functionId=pg_channel_page_data&appid=vip_h5&body=%7BparamData:%7Btoken:%20'a243ca12-6642-4754-bc5e-0ff012681710'%7D%7D";
    const options = {
      headers: {
        cookie: this.cookie,
      },
  ...
  getFruitData = async () => {
    ...
    try {
      ...
      if (data.msg && data.msg == 'not login') {
        ...
        data.farmUserPro.treeState == 2 ||
        data.farmUserPro.treeState == 3
      ) {
        this.fruitState = '100';
      } else if (data.farmUserPro.treeState == 0) {
        this.fruitState = 'X';
      } else {
        this.fruitState = Math.floor(
          (data.farmUserPro.treeEnergy / data.farmUserPro.treeTotalEnergy) * 100
        ).toString();
      }
    } catch (e) {
      console.log(e);
  ...
  run = (filename, args) => {
    ...
    if (this.settings['basicSetting']['directory'] === 'iCloud')
    ...
    const baseSettingOnClick =
      (category) => async (item, _, previewWebView) => {
        await this.alertInput(item.title, item.desc, category, {
          [item.name]: '',
        });
        ...
        this.insertTextByElementId(
          previewWebView,
          item.name,
          this.settings[category][item.name] || ''
        );
      };

    const selectOnClick = (category) => (item, value) => {
      this.settings[category][item.name] = value;
      ...
      [
          ...
          menu: [
            {
              ...
              url: 'https://pic1.imgdb.cn/item/63315c3116f2c2beb1a28cfd.png',
            },
            {
              type: 'input',
              name: 'logo',
              title: '京东标志大小',
              desc: '京东logo（形象狗）大小\n\n缺省值：30',
              url: 'https://pic1.imgdb.cn/item/63315c2c16f2c2beb1a286f1.png',
            },
            {
              type: 'input',
              name: 'userImage',
              ...
              url: 'https://pic1.imgdb.cn/item/63315c3a16f2c2beb1a29a07.png',
            },
            {
              type: 'input',
              name: 'userStack',
              title: '左侧栏宽度',
              desc: '左侧用户信息栏整体宽度\n\n缺省值：103',
              url: 'https://pic1.imgdb.cn/item/63315c3a16f2c2beb1a29a1d.png',
            },
            {
              type: 'input',
              title: '左右栏间距',
              ...
              url: 'https://pic1.imgdb.cn/item/63315c2216f2c2beb1a27870.png',
            },
            {
              type: 'input',
              title: '缓存时间',
              ...
              url: 'https://pic1.imgdb.cn/item/63315c2716f2c2beb1a27f10.png',
            },

            {
              ...
              title: '缓存位置',
              name: 'directory',
              desc: '将缓存保存在Local或者iCloud。\n\n缺省值：Local',
              options: ['Local', 'iCloud'],
              url: 'https://pic1.imgdb.cn/item/63315c2216f2c2beb1a27868.png',
            },
            {
              type: 'input',
              title: '自定义昵称',
              ...
              url: 'https://pic1.imgdb.cn/item/63315c1e16f2c2beb1a2734a.png',
            },
            {
              type: 'input',
              title: '自定义头像',
              ...
              url: 'https://pic1.imgdb.cn/item/63315c1e16f2c2beb1a27341.png',
            },
            {
              type: 'select',
              title: '小组件显示内容',
              name: 'smallShowType',
              desc: '\n缺省值：京豆、钱包数据',
              options: ['京豆、钱包数据', '个人信息'],
              url: 'https://pic1.imgdb.cn/item/63315c3616f2c2beb1a29323.png',
            },
            {
              type: 'select',
              title: '钱包显示类型',
              ...
              options: ['红包', '钢镚和金贴'],
              url: 'https://pic1.imgdb.cn/item/63315c3a16f2c2beb1a299f3.png',
            },
          ],
        },
        {
          ...
          menu: [
            {
              ...
              desc: '京豆数据未与日期对齐的，\n请调低此数值\n\n⚠️如需即时查看调整效果，\n[功能设置]-->刷新图表 需打开。\n\n缺省值：130',
              name: 'height',
              url: 'https://pic1.imgdb.cn/item/63315c2216f2c2beb1a27858.png',
            },
            {
              type: 'input',
              title: '日期文字大小',
              desc: '京豆图表底部日期文字大小\n\n缺省值：9',
              name: 'daySize',
              url: 'https://pic1.imgdb.cn/item/63315c1e16f2c2beb1a27355.png',
            },
            {
              type: 'input',
              title: '日期文字后缀',
              desc: '京豆图表底部日期文字后缀',
              name: 'dayText',
              url: 'https://pic1.imgdb.cn/item/63315c2216f2c2beb1a2785e.png',
            },
            {
              type: 'input',
              title: '京豆数文字大小',
              desc: '京豆图表数据文字大小\n\n⚠️如需即时查看调整效果，\n[功能设置]-->刷新图表 需打开。\n\n缺省值：18',
              name: 'textSize',
              url: 'https://pic1.imgdb.cn/item/63315c3a16f2c2beb1a29a00.png',
            },
            {
              type: 'input',
              title: '京豆数白天颜色',
              desc: '⚠️如需即时查看调整效果，\n[功能设置]-->刷新图表 需打开。\n\n缺省值：999999',
              name: 'textDayColor',
              url: 'https://pic1.imgdb.cn/item/63315c3616f2c2beb1a29310.png',
            },
            {
              type: 'input',
              title: '京豆数晚上颜色',
              desc: '⚠️如需即时查看调整效果，\n[功能设置]-->刷新图表 需打开。\n\n缺省值：999999',
              name: 'textNightColor',
              url: 'https://pic1.imgdb.cn/item/63315c3a16f2c2beb1a299f8.png',
            },
            {
              type: 'input',
              title: '折线图线条颜色',
              ...
              name: 'lineColor',
              url: 'https://pic1.imgdb.cn/item/63315c2716f2c2beb1a27f2e.png',
            },
            {
              type: 'input',
              title: '折线图表顶边距',
              desc: '京豆折线图顶边距\n京豆数据在顶部被剪切显示不全的，\n请调高此数值。\n\n⚠️如需即时查看调整效果，\n[功能设置]-->刷新图表 需打开。\n\n缺省值：15',
              name: 'linePadding',
              url: 'https://pic1.imgdb.cn/item/63315c2716f2c2beb1a27f3a.png',
            },
            {
              type: 'input',
              title: '柱状图表顶边距',
              desc: '京豆柱状图和曲线面积图顶边距\n京豆数据在顶部被剪切显示不全的,\n请调高此数值。\n\n⚠️如需即时查看调整效果，\n[功能设置]-->刷新图表 需打开。\n\n缺省值：5',
              name: 'barPadding',
              url: 'https://pic1.imgdb.cn/item/63315c0816f2c2beb1a25263.png',
            },
            {
              type: 'select',
              title: '小组件图表类型',
              desc: '\n缺省值：双日视图',
              name: 'smallShowType',
              options: ['双日视图', '折线图表', '柱状图表', '曲线面积图'],
              url: 'https://pic1.imgdb.cn/item/63315c3616f2c2beb1a29330.png',
            },
            {
              type: 'select',
              title: '中组件图表类型',
              ...
              name: 'showType',
              options: ['双日视图', '折线图表', '柱状图表', '曲线面积图'],
              url: 'https://pic1.imgdb.cn/item/63315c3616f2c2beb1a29315.png',
            },
            {
              type: 'select',
              title: '每日京豆数计算',
              ...
              name: 'countBean',
              options: ['收入-支出', '收入'],
              url: 'https://pic1.imgdb.cn/item/63315c1e16f2c2beb1a27376.png',
            },
            {
              type: 'switch',
              title: '多彩柱状图',
              desc: '设置为打开时仅对柱状图表生效\n\n缺省值：关闭',
              name: 'colorful',
              url: 'https://pic1.imgdb.cn/item/63315c0816f2c2beb1a2524a.png',
            },
          ],
        },
        {
          ...
          menu: [
            {
              ...
              name: 'showBaitiao',
              url: 'https://pic1.imgdb.cn/item/63315c3116f2c2beb1a28d19.png',
            },
            {
              type: 'switch',
              title: '包裹信息',
              ...
              name: 'showPackage',
              url: 'https://pic1.imgdb.cn/item/63315c3016f2c2beb1a28cf8.png',
            },
            {
              type: 'switch',
              title: '农场进度',
              desc: '显示东东农场种植进度。\n\n缺省值：打开',
              name: 'showFruit',
              url: 'https://pic1.imgdb.cn/item/63315c3116f2c2beb1a28d24.png',
            },
            {
              type: 'switch',
              title: '运行日志',
              ...
              name: 'logable',
              url: 'https://pic1.imgdb.cn/item/63315c2716f2c2beb1a27f0a.png',
            },
            {
              type: 'switch',
              title: '刷新图表',
              ...
              name: 'alwaysRefreshChart',
              url: 'https://pic1.imgdb.cn/item/63315c0816f2c2beb1a25259.png',
            },
          ],
        },
        {
          menu: [
            {
              icon: { name: 'arrowshape.turn.up.left.2', color: '#f5222d' },
              title: '重置参数',
              name: 'clearAll',
              onClick: async () => {
                const options = ['取消', '重置'];
                ...
                this.saveSettings(false);
                this.notify(this.name, '重置参数成功，请重新运行当前脚本');
                this.reopenScript();
              },
            },
          ],
        ...
        item.menu.map((menuItem) => {
          ...
          if (menuItem.type === 'select') {
            menuItem.onClick = selectOnClick(item.key);
          }
          if (menuItem.type === 'switch') {
            menuItem.defaultValue = `${menuItem.defaultValue === '打开'}`;
            menuItem.onClick = (_, value) => {
              this.settings[item.key][menuItem.name] =
                value === 'true' ? '打开' : '关闭';
              console.log(this.settings[item.key]);
              return this.saveSettings(false);
            };
          }
        });
    ...
    if (config.runsInApp) {
      this.registerAction({
        url: 'https://raw.githubusercontent.com/githubdulong/Script/master/Images/setting.png',
        title: '参数配置',
        name: 'paramsConfig',
