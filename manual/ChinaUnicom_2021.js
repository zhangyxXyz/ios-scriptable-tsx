...
class Widget extends DmYY {
    constructor(arg) {
        ...
        this.verticalLogo =
            'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-b1ebbd3c-ca49-405b-957b-effe60782276/00010042-8cc7-4931-afe2-b65ee49f6374.png'
        this.Run()
    }
    ...
    Run() {
        if (config.runsInApp) {
            ...
            this.registerAction(
                '尺寸设置',
                async () => {
                    await this.setAlertInput(`${this.name}尺寸设置`, '进度条大小|文字大小', {
            ...
            this.registerAction(
                '账号设置',
                async () => {
                    await this.setAlertInput(`${this.name}账号`, '读取 BoxJS 缓存信息', { cookie: 'cookie' })
                },
