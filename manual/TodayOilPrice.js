...
var GenrateView = class {
    ...
    static b64image(props) {
        return async parentInstance => {
            ...
            let _req = new Request(src)
            let _image = await _req.loadImage()
            const widgetImage = parentInstance.addImage(_image)
            widgetImage.image = _image
            try {
                isDefined(href) && (widgetImage.url = href)
    ...
    static wtext(props, ...children) {
        return async parentInstance => {
            ...
            const { textColor, font, family, opacity, maxLine, scale, shadowColor, shadowRadius, shadowOffset, href, textAlign, onClick } =
                props
            ...
            try {
                ...
                if (isDefined(family)) {
                    isDefined(font) && (widgetText.font = typeof font === 'number' ? new Font(family, font) : font)
                } else {
...
function h(type, props, ...children) {
    ...
    switch (type) {
        ...
        case 'b64image':
            return GenrateView.b64image(props)
        case 'wspacer':
...
var Widget = class extends Base_default {
    constructor() {
        ...
        this.logoTintColor = '#FC6D26' // logo 着色
        this.oilNameColor = '#FC6D26'
        this.oilPriceColor = 'ffffff'
        this.componentWillMount = async () => {
            ...
            this.baseActions = [
                {
                    ...
                    onClick: async () => {
                        const inputValue = {
                            ...
                            bodyColor: '加油站背景',
                            footColor: '底部背景颜色',
                            logoTintColor: '底部logo颜色',
                            oilNameColor: '油名称字体颜色',
                            oilPriceColor: '油价格字体颜色'
                        }
            ...
            const { headerColor, bodyColor, footColor, logoTintColor, oilNameColor, oilPriceColor } =
                (await getSetting('oilBackground')) || {}
            this.headerColor = headerColor || this.headerColor
            this.bodyColor = bodyColor || this.bodyColor
            this.footColor = footColor || this.footColor
            this.logoTintColor = logoTintColor || this.logoTintColor
            this.oilNameColor = oilNameColor || this.oilNameColor
            this.oilPriceColor = oilPriceColor || this.oilPriceColor
            this.fontColor = '#fff'
        }
        ...
        this.renderWebView = async str => {
            ...
            // 直辖市省份为空
            let _area = [str[0] ? pinyin_default.fullChar(str[0].replace('省', '')) : '', pinyin_default.fullChar(str[1])]
            if (!_area[0]) {
    ...
    `
        ...
        this.content = data => {
            var isGasoline = data.cate.indexOf('汽油') != -1
            return /* @__PURE__ */ h(
                'wstack',
                {
                ...
                /* @__PURE__ */ h(
                    ...
                    /* @__PURE__ */ h(
                        ...
                        {
                            textAlign: 'center',
                            textColor: this.oilNameColor || this.fontColor,
                            font: 26,
                            family: 'Chalkduster'
                        },
                ...
                /* @__PURE__ */ h(
                    ...
                    /* @__PURE__ */ h(
                        'wtext',
                        {
                            textColor: this.oilPriceColor || this.fontColor,
                            font: 16,
                            family: 'Chalkduster',
                            textAlign: 'center'
                        },
        ...
        this.stackCellText = data => {
            return /* @__PURE__ */ h(
                ...
                /* @__PURE__ */ h('wimage', {
                    ...
                    width: 10,
                    height: 10,
                    filter: data.iconColor || this.fontColor
                }),
                /* @__PURE__ */ h('wspacer', {
                    length: 5
                }),
        ...
        this.stackGasStation = gasStation => {
            return gasStation.map((item, index) => {
                ...
                return /* @__PURE__ */ h(
                    ...
                    this.stackCellText({ value: item.address, label: '地址', href, icon: 'mappin.and.ellipse', iconColor: '#E06C75' }),
                    /* @__PURE__ */ h('wspacer', {
                        length: 2
                    }),
            ...
            return /* @__PURE__ */ h(
                ...
                /* @__PURE__ */ h(
                    ...
                    /* @__PURE__ */ h(
                        ...
                        '今日油价 • ' + (locality[0] ? locality[0].replace('省', '') : '') + locality[1].replace('市', '')
                    ),
                    /* @__PURE__ */ h('wspacer', null),
                    /* @__PURE__ */ h('wimage', {
                        src: 'arrow.clockwise',
