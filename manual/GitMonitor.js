...
class Widget extends WidgetBase {
    ...
    parseRepoUrl(url) {
        ...
        if (gitlabMatch) {
            let domain = gitlabMatch[1].replace(/^https?:\/\//, '');
    ...
    async getData() {
        ...
        try {
            ...
            let data = await this.$request.get(apiUrl, { headers })
            this.commits = data
    ...
    Run() {
        try {
            ...
            let defaultRepoDisplayValue = this.getDefaultRepoDisplay()
