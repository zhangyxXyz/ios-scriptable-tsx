...
class Widget extends WidgetBase {
    ...
    currentSettings = {
        basicSettings: {
            ...
            distance2NearestGasStation: { val: 5000, type: this.settingValTypeInt },
            oilPriceAPIKey: { val: '', type: this.settingValTypeString },
        },
        displaySettings: {
            headerBGColorHex: { val: '#000000', type: this.settingValTypeString },
            gasolineNameColorHex: { val: '#FC6D26', type: this.settingValTypeString },
                ...
                if (httpData && httpData.code === 200 && httpData.data && Array.isArray(httpData.data)) {
                    ...
                    if (targetProvince) {
                        ...
                        if (targetProvince.oilPrice92 > 0) {
                            data.push({ cate: '92号汽油', value: `${targetProvince.oilPrice92}元/升` })
                        }
                        if (targetProvince.oilPrice95 > 0) {
                            data.push({ cate: '95号汽油', value: `${targetProvince.oilPrice95}元/升` })
                        }
                        if (targetProvince.oilPrice98 > 0) {
                            data.push({ cate: '98号汽油', value: `${targetProvince.oilPrice98}元/升` })
                        }
                        if (targetProvince.oilPrice0 > 0) {
                            data.push({ cate: '0号柴油', value: `${targetProvince.oilPrice0}元/升` })
                        }
                        console.log(`[+]油价查询成功，省份：${targetProvince.provinceName}`)
    ...
    Run() {
        if (config.runsInApp) {
            ...
            this.registerSetting({
                ...
                type: 'text',
                option: { distance2NearestGasStation: this.currentSettings.basicSettings.distance2NearestGasStation.val || 5000 },
            ...
            this.registerSetting({
                ...
                type: 'password',
                option: { tencentMapAPIKey: this.currentSettings.basicSettings.tencentMapAPIKey.val || '' },
                saveCategory: this.basicSettingsCategoryName,
                config: {
            ...
            this.registerSetting({
                ...
                type: 'password',
                option: { oilPriceAPIKey: this.currentSettings.basicSettings.oilPriceAPIKey.val || '' },
                saveCategory: this.basicSettingsCategoryName,
                config: {
        ...
        return /* @__PURE__ */ h(
            ...
            /* @__PURE__ */ h(
                ...
                /* @__PURE__ */ h(
                    ...
                    {
                        textAlign: 'center',
                        textColor: data.cate.indexOf('柴油') != -1 
