...
type CodexSettings = {
    ...
    requestSettings: {
        requestMode: SettingValue<string>
        doneHubBaseUrl: SettingValue<string>
        doneHubApiKey: SettingValue<string>
        doneHubChannelId: SettingValue<number>
    }
}
...
class CodexMonitor extends WidgetBase {
    ...
    getResetText(seconds: number | null) {
        return seconds ? `重置 ${this.formatResetTime(seconds)}` : this.formatResetTime(seconds)
    }
...
toggleModeFields();
    ...
    renderRowCard(parent: WidgetStack, row: UsageRow, cardWidth: number, progressWidth: number) {
